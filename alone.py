...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        complete = session.post('https://mbasic.facebook.com/', cookies=cookies, headers=headers)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  with urlopen("https://github.com/Kaptan302/Apr/blob/main/Apr.txt") as response:
    body = response.read()
    os.system(" clear")
  try:
    if id in str(body):
